export const Items: {[itemid: string]: ItemData} = {
	...
	parasol: {
		...
		onModifyDefPriority: 1,
		onModifyDef(def, pokemon) {
			if ((pokemon.baseSpecies.name === 'Chibi Yuuka') ||
			(pokemon.baseSpecies.name === 'Yuuka') ||
			(pokemon.baseSpecies.name === 'EX Yuuka'))
			{
				return this.chainModify(2);
			}
		},
		itemUser: ["Chibi Yuuka", "Yuuka", "EX Yuuka"],
		num: -138,
		gen: 3,
	},
	iceburngem: {
	...
	lunarvest: {
		...
		onModifyDefPriority: 1,
		onModifyDef(def, pokemon) {
			if (pokemon.baseSpecies.name === 'Reisen II') {
				return this.chainModify(2);
			}
		},
		itemUser: ["Reisen II"],
