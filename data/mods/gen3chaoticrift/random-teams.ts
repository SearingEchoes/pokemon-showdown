...
//only rest/trick2 have been dealt with so far
...
export class RandomGen3Teams extends RandomGen4Teams {
	...
	getItem(
		...
		if (species.name === 'Beesiney') return 'Bunny Amulet';
		if (species.name === 'Wesker') return "Dharok's Greataxe";
